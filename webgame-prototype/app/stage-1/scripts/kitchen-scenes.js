...
window.createKitchenScenes = function (options) {
  ...
  var backgroundRoot = "assets/masters/stage-1/backgrounds/";
  var propRoot = "assets/masters/stage-1/props/";
  var background = backgroundRoot + "bg-stove-controls-v4.png";
  var towel = propRoot + "prop-towel-draped-alpha-v1.png";
  var handle = propRoot + "prop-valve-handle-alpha-v2.png";
